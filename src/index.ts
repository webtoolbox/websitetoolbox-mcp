...
}, async ({ categoryId, userGroupId, ...perms }) => {
...
server.tool("list_messages", "List messages in a conversation", {
  ...
  page: z.number().optional().describe("Page number"),
}, async ({ conversationId, limit, page }) => {
